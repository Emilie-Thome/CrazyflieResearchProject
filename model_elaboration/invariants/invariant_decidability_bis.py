import numpy as np
from sympy import *
from sympy.abc import x, y, z, v, a, b, k, l, m, n
...
dz  = Poly(v, z, v, x, y, k, l, m, n, domain='QQ[a, b]')
dvz = Poly(2*a*z+a*v+b*x-1/2*y, z, v, x, y, k, l, m, n, domain='QQ[a, b]')
du1 = Poly(-2*z-v+1/2*y, z, v, x, y, k, l, m, n, domain='QQ[a, b]')
du2 = Poly(-z, z, v, x, y, k, l, m, n, domain='QQ[a, b]')

# Gröbner Basis: {-2*m-4*n-2*k+y,-l-m-2*n+2*a*n-k+a*k+b*x,-k+v,-n+z} from mathematica
grobner = [	Poly(-2*m+4*n-2*k+y, z, v, x, y, k, l, m, n, domain='QQ[a, b]'), \
			Poly(-l-m+2*n-2*a*n-k+a*k+b*x, z, v, x, y, k, l, m, n, domain='QQ[a, b]'), \
			Poly(-k+v, z, v, x, y, k, l, m, n, domain='QQ[a, b]'), \
			Poly(n+z, z, v, x, y, k, l, m, n, domain='QQ[a, b]')]
...
inv = Poly(	b**2*(8*b**3*x**4-12*a*b**2*x**3*y-16*b**3*x**3*y+\
			...
			32*b**2*v*z**3+2*b*z**4+8*a*b*z**4+32*b**2*z**4), z, v, x, y, k, l, m, n, domain='QQ[a, b]')

var_dz  = Poly(k, z, v, x, y, k, l, m, n, domain='QQ[a, b]')
var_dvz = Poly(l, z, v, x, y, k, l, m, n, domain='QQ[a, b]')
var_du1 = Poly(m, z, v, x, y, k, l, m, n, domain='QQ[a, b]')
var_du2 = Poly(n, z, v, x, y, k, l, m, n, domain='QQ[a, b]')
...
def differential_order(p):
	...
	Np = 0
	while not_in_differential_order(p_to_add, lie_derivatives) :
		print(Np)
		lie_derivatives.append(p_to_add)
		...
		p_to_add = (((var_dz.mul(p_dz)).add(var_dvz.mul(p_dvz))).add(var_du1.mul(p_du1))).add(var_du2.mul(p_du2))
